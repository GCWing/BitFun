FILE: E:\Yuanban\cc-haha-src\src\utils\hooks\AsyncHookRegistry.ts
LINES: 309
==========
import type {
  AsyncHookJSONOutput,
...
> {
  ...
  // Snapshot hooks before processing 鈥?we'll mutate the map after.
  ...
  // allSettled 鈥?isolate failures so one throwing callback doesn't orphan
