FILE: E:\Yuanban\cc-haha-src\src\utils\hooks\hooksConfigSnapshot.ts
LINES: 133
==========
...
function getHooksFromAllowedSources(): HooksSettings {
  ...
  // Plugin hooks (registered channel, hooks.ts:1391) are NOT affected 鈥?
  ...
  // hooks are gated at REGISTRATION (runAgent.ts:~535) by agent source 鈥?
