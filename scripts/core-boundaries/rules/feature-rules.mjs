...
export const optionalDependencyFeatureOwnerRules = [
  ...
  },
  {
    ...
    dependencies: [
      ...
      { depName: 'hex', ownerFeatures: ['mcp', 'plugin-source', 'remote-connect'] },
      ...
      { depName: 'sha2', ownerFeatures: ['canvas-runtime', 'mcp', 'plugin-source', 'remote-connect', 'remote-ssh', 'review-platform', 'speech'] },
