...
export const facadeOnlyFiles = [
  {
    path: 'src/crates/facade/core/src/infrastructure/filesystem/mod.rs',
  ...
  {
    path: 'src/crates/facade/core/src/service/filesystem/listing.rs',
    importPrefix: 'bitfun_services_core::filesystem',
    reason: 'core filesystem listing facade must only re-export the services-core owner crate',
  },
  {
    path: 'src/crates/facade/core/src/service/filesystem/types.rs',
    importPrefix: 'bitfun_services_core::filesystem',
    reason: 'core filesystem DTO facade must only re-export the services-core owner crate',
  },
  {
    path: 'src/crates/facade/core/src/service/git/git_service.rs',
  ...
  {
    path: 'src/crates/facade/core/src/service/mcp/tool_info.rs',
  ...
  {
    path: 'src/crates/facade/core/src/service/mcp/tool_name.rs',
    importPrefix: 'bitfun_services_integrations::mcp',
    reason: 'core MCP tool name facade must only re-export the integrations owner crate',
  },
  {
    path: 'src/crates/facade/core/src/service/mcp/protocol/types.rs',
    importPrefix: 'bitfun_services_integrations::mcp',
    reason: 'core MCP protocol types facade must only re-export the integrations owner crate',
  },
  {
    path: 'src/crates/facade/core/src/service/mcp/protocol/transport.rs',
  ...
  {
    path: 'src/crates/facade/core/src/service/mcp/server/connection.rs',
