# tool-runtime Agent Guide

Scope: this guide applies to `src/crates/execution/tool-runtime`.
...
- Provider-neutral contracts belong in `bitfun-agent-tools`; product provider
  grouping belongs in `bitfun-tool-packs`.
