...
- `miniapp` owns MiniApp DTOs, compiler/bridge helpers, storage/draft/import
  ...
  built-in update/decline decisions, built-in bundle/hash/marker seed-decision
  contracts, built-in source/placeholder payload contracts, port traits, and
  storage-backed runtime state facade logic.
