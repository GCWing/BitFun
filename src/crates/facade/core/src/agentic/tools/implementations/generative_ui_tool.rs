...
17. `data-file-path` may be workspace-relative such as `src/crates/facade/core/src/lib.rs`, or absolute when already verified, but it MUST resolve to a file, not a directory.
