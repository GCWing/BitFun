...
mod tests {
            ...
            "workPackets": [
                {
                    ...
                    "assignedScope": {
                        "files": [
                            "src/crates/facade/core/src/auth.rs",
                            "src/crates/facade/core/src/token.rs"
                        ]
                    }
                }
            ]
    ...
    fn deep_review_retry_accepts_reduced_partial_timeout_scope() {
        ...
        assert_eq!(retry_scope, vec!["src/crates/facade/core/src/token.rs"]);
    }
