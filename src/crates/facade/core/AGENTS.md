...
This file applies to `src/crates/facade/core`. Use the top-level `AGENTS.md` for
...
- `src/crates/execution/agent-tools/AGENTS.md`
- `src/crates/execution/harness/AGENTS.md`
- `src/crates/product/product-domains/AGENTS.md`
...
- `src/crates/execution/tool-packs/AGENTS.md`

Narrower local guides already exist for some subtrees:

- `src/crates/integrations/ai-adapters/AGENTS.md`
