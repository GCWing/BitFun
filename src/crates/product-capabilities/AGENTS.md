...
runtime services, tool provider groups, and harness providers a product
capability requires. It does not own concrete runtime execution.
...
- Keep this crate limited to stable capability ids, service capability facts,
  tool provider group selection, and harness provider descriptors.
