...
use crate::service::session::ModelRoundData;
...
pub struct RoundResult {
    /// Completed persisted representation for this model round.
    pub model_round: ModelRoundData,
...
pub struct ExecutionResult {
    ...
    /// Completed persisted representation for each model round in this turn.
