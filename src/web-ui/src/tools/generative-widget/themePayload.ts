...
const WIDGET_THEME_STATIC_SHELL_VARS = {
  ...
  '--color-overlay-white-10': `color-mix(in srgb, ${widgetVar(FALLBACK_VAR.staticWhite)} 10%, transparent)`,
  ...
  '--color-overlay-black-10': `color-mix(in srgb, ${widgetVar(FALLBACK_VAR.staticBlack)} 10%, transparent)`,
