...
const systemTokenSources = {
  ...
  'font.family.sans': '--bf-appearance-token-font-family-sans',
  'font.family.mono': '--bf-appearance-token-font-family-mono',
  'font.size.xs': '--bf-appearance-token-font-size-xs',
  'font.size.sm': '--bf-appearance-token-font-size-sm',
  'font.size.base': '--bf-appearance-token-font-size-base',
  'font.size.lg': '--bf-appearance-token-font-size-lg',
  'font.size.xl': '--bf-appearance-token-font-size-xl',
  'font.size.2xl': '--bf-appearance-token-font-size-2xl',
  'font.size.3xl': '--bf-appearance-token-font-size-3xl',
  'font.size.4xl': '--bf-appearance-token-font-size-4xl',
  'font.size.caption': '--bf-appearance-token-font-size-xs',
  'font.size.small': '--bf-appearance-token-font-size-sm',
  'font.size.body': '--bf-appearance-token-font-size-base',
  'font.size.label': '--bf-appearance-token-font-size-base',
  'font.size.title': '--bf-appearance-token-font-size-2xl',
  'font.size.display': '--bf-appearance-token-font-size-4xl',
  'font.weight.regular': '--bf-appearance-token-font-weight-normal',
  'font.weight.medium': '--bf-appearance-token-font-weight-medium',
  'font.weight.semibold': '--bf-appearance-token-font-weight-semibold',
  'font.weight.bold': '--bf-appearance-token-font-weight-bold',
  'lineHeight.tight': '--bf-appearance-token-line-height-tight',
  'lineHeight.base': '--bf-appearance-token-line-height-base',
  'lineHeight.body': '--bf-appearance-token-line-height-base',
  'lineHeight.relaxed': '--bf-appearance-token-line-height-relaxed',
