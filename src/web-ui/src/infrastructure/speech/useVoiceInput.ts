...
export function useVoiceInput({ onTranscript }: UseVoiceInputOptions): VoiceInputController {
  ...
  }, [attachSession, clearRecordingLimitTimer, t]);
  ...
  }, [attachSession, enqueueChunk, modelInstalled, openVoiceInputSettings, settings, speechRuntimeSupported, stopAndTranscribe, t]);
