...
import { learningProposalAPI } from './service-api/LearningProposalAPI';
import { insightsApi } from './insightsApi';
import { speechAPI } from './service-api/SpeechAPI';

// Export API modules
export { workspaceAPI, configAPI, aiApi, toolAPI, agentAPI, systemAPI, projectAPI, diffAPI, snapshotAPI, globalAPI, contextAPI, cronAPI, permissionAPI, pageAPI, gitAPI, gitAgentAPI, gitRepoHistoryAPI, startchatAgentAPI, sessionAPI, i18nAPI, btwAPI, editorAiAPI, reviewPlatformAPI, learningProposalAPI, insightsApi, speechAPI };
export * from './service-api/ReviewPlatformAPI';
export * from './service-api/LearningProposalAPI';
...
export const bitfunAPI = {
  ...
  learningProposal: learningProposalAPI,
