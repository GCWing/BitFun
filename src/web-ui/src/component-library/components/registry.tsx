...
const previewTextSubtle = 'color-mix(in srgb, var(--bf-color-content-on-dark) 60%, var(--bf-color-content-on-light))';
const previewTextDisabled = 'color-mix(in srgb, var(--bf-color-content-on-dark) 40%, var(--bf-color-content-on-light))';
    ...
    components: [
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>读取文件 - 成功</h3>
            <ReadFileDisplay
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>读取文件 - 执行中</h3>
            <ReadFileDisplay
              toolItem={createMockToolItem('Read',
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>写入文件</h3>
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>编辑文件</h3>
            <FileOperationToolCard
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>删除文件</h3>
            <FileOperationToolCard
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>Grep 搜索结果</h3>
            <GrepSearchDisplay
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>Grep - 多结果示例</h3>
            <GrepSearchDisplay
              toolItem={createMockToolItem('Grep',
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>Glob 搜索结果</h3>
            <GlobSearchDisplay
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>LS 目录列表</h3>
            <LSDisplay
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>AI 任务 - 执行中</h3>
            <TaskToolDisplay
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>AI 任务 - 已完成</h3>
            <TaskToolDisplay
              toolItem={createMockToolItem('Task',
                {
                  description: '创建新功能',
...
所有需求均已满足`,
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>Todo - 基础示例</h3>
            <TodoWriteDisplay
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>Todo - 多任务示例</h3>
            <TodoWriteDisplay
              toolItem={createMockToolItem('TodoWrite',
                {
                  todos: [
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>Todo进度 - 进行中</h3>
            <TodoWriteDisplay
              toolItem={createMockToolItem('TodoWrite',
                {
                  todos: [
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>Todo - 待处理</h3>
            <TodoWriteDisplay
              toolItem={createMockToolItem('TodoWrite',
                {
                  todos: [
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>Todo - 已完成</h3>
            <TodoWriteDisplay
              toolItem={createMockToolItem('TodoWrite',
                {
                  todos: [
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>网页搜索 - 结果</h3>
            <RealWebSearchCard
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>多结果 - 网页搜索</h3>
            <RealWebSearchCard
              toolItem={createMockToolItem('WebSearch',
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>MCP工具 - 文件列表</h3>
            <MCPToolDisplay
              ...
              config={{
                ...
                description: 'MCP工具调用',
                displayMode: 'compact',
                primaryColor: 'var(--bf-color-accent-secondary)'
              }}
              sessionId="preview-session"
            />

            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>MCP - 执行中</h3>
            <MCPToolDisplay
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>上下文压缩 - 示例</h3>
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>上下文压缩 - 本地 fallback</h3>
            <ContextCompressionDisplay
              toolItem={createMockToolItem('ContextCompression',
                {
                  trigger: 'manual',
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>上下文压缩 - 执行中</h3>
            <ContextCompressionDisplay
              toolItem={createMockToolItem('ContextCompression',
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>Skill调用</h3>
            <SkillDisplay
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>向用户提问 - 单题示例</h3>
            <AskUserQuestionCard
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>多问题 - 单选和多选</h3>
            <AskUserQuestionCard
              toolItem={createMockToolItem('AskUserQuestion',
                {
                  questions: [
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>已回答 - 数据库选择</h3>
            <AskUserQuestionCard
              toolItem={createMockToolItem('AskUserQuestion',
                {
                  questions: [
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>Write Plan - Streaming</h3>
            <FileOperationToolCard
              toolItem={createMockToolItem('Write', {
      ...
      },
      {
        ...
        component: () => (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>InitMiniApp - 执行中</h3>
            <InitMiniAppDisplay
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>InitMiniApp - 参数流式</h3>
            <InitMiniAppDisplay
              toolItem={
                {
            ...
            <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>InitMiniApp - 创建成功</h3>
            <InitMiniAppDisplay
              toolItem={createMockToolItem(
                'InitMiniApp',
      ...
      },
      {
        ...
        component: () => {
          ...
          return (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', padding: '20px' }}>
              <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginBottom: '8px' }}>模型思考 - 流式输出</h3>
...
继续深入分析相关细节..`,
              ...
              <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>模型思考 - 折叠完成状态</h3>
              <ModelThinkingDisplay
                thinkingItem={createMockThinkingItem(
                  `分析了用户关于性能优化的问题
...
以上方案可以显著提升应用性能`,
              ...
              <h3 style={{ color: 'var(--bf-color-content-on-dark)', marginTop: '16px', marginBottom: '8px' }}>模型思考 - 长内容展示</h3>
              <ModelThinkingDisplay
                thinkingItem={createMockThinkingItem(
                  `这是一个复杂任务，需要多步骤分析
