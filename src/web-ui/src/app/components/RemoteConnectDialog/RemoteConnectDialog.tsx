...
const FEISHU_SETUP_GUIDE_URLS = {
  'zh-CN': 'https://github.com/GCWing/BitFun/blob/main/docs/guideline/feishu-bot-setup.zh-CN.md',
  'en-US': 'https://github.com/GCWing/BitFun/blob/main/docs/guideline/feishu-bot-setup.md',
