...
export const SETTINGS_TAB_SEARCH_CONTENT: Record<ConfigTab, readonly SettingsTabSearchPhrase[]> = {
  ...
  memories: [
    ...
    { ns: 'settings/memories', key: 'sections.models.title' },
    { ns: 'settings/memories', key: 'sections.advanced.title' },
    { ns: 'settings/memories', key: 'fields.memoryEnabled.label' },
    { ns: 'settings/memories', key: 'fields.generateForBtwSessions.label' },
    { ns: 'settings/memories', key: 'fields.externalContextPolicy.label' },
    { ns: 'settings/memories', key: 'fields.extractModel.label' },
    { ns: 'settings/memories', key: 'fields.consolidationModel.label' },
