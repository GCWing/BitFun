impl ChatView {
    ...
    pub(crate) fn show_account_panel(
        &mut self,
        info: crate::tui_management::AccountInfo,
        devices: Vec<crate::tui_management::AccountDevice>,
        sync_progress: crate::tui_management::SettingsSyncProgress,
    ) {
    ...
    pub(crate) fn update_account_panel_progress(
        &mut self,
        devices: Option<Vec<crate::tui_management::AccountDevice>>,
        sync_progress: crate::tui_management::SettingsSyncProgress,
    ) {
        self.login_form
