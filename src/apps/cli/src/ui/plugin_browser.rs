...
fn plugin_display_status(
    trust: bitfun_core::plugin_source::ManagedPluginTrustLevel,
    activated: bool,
) -> PluginDisplayStatus {
    use bitfun_core::plugin_source::ManagedPluginTrustLevel;
    match trust {
...
pub(crate) fn plugin_trust_label(
    trust: bitfun_core::plugin_source::ManagedPluginTrustLevel,
) -> &'static str {
    use bitfun_core::plugin_source::ManagedPluginTrustLevel;
    match trust {
...
pub(crate) fn plugin_item_from_view(
    view: &bitfun_core::plugin_source::ManagedPluginPackageView,
) -> PluginItem {
    PluginItem {
...
pub(crate) fn plugin_items_from_snapshot(
    snapshot: &bitfun_core::plugin_source::ManagedPluginSourceSnapshot,
) -> Vec<PluginItem> {
    snapshot
        .packages
        .iter()
