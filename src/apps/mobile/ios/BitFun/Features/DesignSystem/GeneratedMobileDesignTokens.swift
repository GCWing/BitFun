...
enum MobileDesignColors {
    ...
    static let pageBg = dynamic(light: 0xFFFDFDFB, dark: 0xFF151514)
    static let pageBgFade = dynamic(light: 0x00FDFDFB, dark: 0x00151514)
...
enum MobileDesignTypography {
    ...
    static let conversationHeaderTitle = MobileTypographyToken(size: 18, lineHeight: 22, weight: .medium)
...
enum MobileDesignGeometry {
    ...
    static let composerActionSize: CGFloat = 40
    static let composerInputHeight: CGFloat = 42
    static let composerExpandedInputHeight: CGFloat = 74
    static let composerCollapsedHeight: CGFloat = 52
    static let composerExpandedInputRowHeight: CGFloat = 76
    static let composerExpandedActionRowHeight: CGFloat = 44
