...
export const mobileComponents = {
  ...
  "components": {
    ...
    "miniapp_navigation": {
      ...
      "platformNotes": "Use a quiet 48vp icon-and-label row in compact and wide sidebars, with 16vp medium-weight navigation text, a 24vp icon slot and a 14vp gap. HarmonyOS uses the native outlined sys.symbol.square_grid_2x2 at 24vp, centered in its slot and tinted with the semantic ink color. Do not promote this navigation destination to a primary action on remote home."
    },
    "miniapp_catalog": {
