...
export const messages: Record<MobileLanguage, MessageTree> = {
  'en-US': {
    ...
    devices: {
      ...
      tokenExpired: 'Account authorization expired. Re-scan the QR code or ask the desktop user to log in again.',
    },
    tools: {
      ls: 'LS',
      glob: 'Glob',
  ...
  'zh-CN': {
    ...
    devices: {
      ...
      tokenExpired: '账号授权已过期，请重新扫码或让桌面端用户重新登录。',
    },
    tools: {
      ls: '列表',
      glob: 'Glob',
  ...
  'zh-TW': {
    ...
    devices: {
      ...
      switchFailed: '切換設備失敗',
      controllingDevice: '正在控制 {name}',
      tokenExpired: '帳號授權已過期，請重新掃碼或讓桌面端用戶重新登入。',
    },
    tools: {
      ls: '列表',
      glob: 'Glob',
