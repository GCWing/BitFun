...
export const messages: Record<MobileLanguage, MessageTree> = {
  'en-US': {
    ...
    devices: {
      title: 'Devices',
      noDelegatedIdentity: 'The paired desktop is not logged into a BitFun account. Please log in on the desktop to enable multi-device control.',
      loading: 'Loading...',
      noDevices: 'No devices found',
      noSessions: 'No sessions',
      newSession: '+ New Session',
      selected: 'Selected',
      tokenExpired: 'Session expired. Please re-pair or ask the desktop user to log in again.',
      loadDeviceFailed: 'Failed to load device',
  ...
  'zh-CN': {
    ...
    devices: {
      ...
      newSession: '+ 新建会话',
      selected: '已选中',
      tokenExpired: '会话已过期，请重新配对或让桌面端用户重新登录。',
  ...
  'zh-TW': {
    ...
    devices: {
      ...
      newSession: '+ 新建會話',
      selected: '已選中',
      tokenExpired: '會話已過期，請重新配對或讓桌面端用戶重新登入。',
      loadDeviceFailed: '加載設備失敗',
      loadMessagesFailed: '加載消息失敗',
      sendFailed: '發送失敗',
      createSessionFailed: '創建會話失敗',
      sendMessage: '發送',
      sendMessagePlaceholder: '發送消息...',
      sessionsTitle: '會話',
      chatTitle: '聊天',
      online: '🟢',
      offline: '⚪',
