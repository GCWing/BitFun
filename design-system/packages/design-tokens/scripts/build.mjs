...
assertRequiredTokens(systemTokens, [
  ...
  "overlay.modal.backdropBlur",
  "overlay.modal.surfaceRadius",
  "overlay.modal.headerGap",
  "overlay.modal.headerPaddingBlockStart",
  "overlay.modal.headerPaddingBlockEnd",
  "overlay.modal.headerPaddingInline",
  "overlay.modal.titleFontSize",
  "overlay.modal.titleFontWeight",
  "overlay.modal.scrollbarWidth",
