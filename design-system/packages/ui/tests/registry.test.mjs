...
test("registry exposes only the formal stable components", () => {
  assert.deepEqual(
    ...
    ["ActionItem", "ActivityItem", "Button", "Card", "Composer", "Field", "IconButton", "Input", "KeyHint", "Menu", "Modal", "NavigationPanel", "PageHeader", "ScrollArea", "SearchField", "Switch", "TabGroup", "Toolbar"],
  );
  assert.equal(
