...
| [product-requirements-agent-workflow-adjustment.md](product-requirements-agent-workflow-adjustment.md) | 非权威候选调整提案 | 智能体工作流、并发 GUI、审查降级、token 成本和任务完成度平衡；采纳前需回填权威文档 |
