...
| `cssVarDefinitions.staticContractDefinedUnique` | 493 | 493 | 控制静态 root contract key 总量，避免新增主题时需要维护不可扩展的大型 CSS var 表 |
...
| `cssVarDefinitions.staticContractLowExternalUsageUnique` | 283 | 283 | 暴露低外部消费 key，作为后续继续压缩 root contract 的候选队列 |
