...
产品定制中的 Brand Pack、GUI Blueprint 和 TUI Blueprint 只引用对应界面宿主已注册的 theme/preset
ID 或明确列出的语义色；详细定制边界见
[`product-customization-blueprint.md`](product-customization-blueprint.md)。Blueprint 不拥有主题 schema，构建
