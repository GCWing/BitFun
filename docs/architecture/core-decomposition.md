...
- remote-connect command/response wire DTO、remote model catalog DTO、poll response assembly /
  ...
  concrete scheduler submit adapter、workspace-root source、persistence/workspace service reads、remote chat history projection / image compression / enhanced-input cleanup 与
