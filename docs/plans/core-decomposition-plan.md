...
agent definition registry loading、permission coordination、runtime events、prompt loop facts 和 concrete
scheduler lifecycle 的受保护迁移。
...
- thread goal runtime、subagent visibility/availability、round-boundary yield/injection 和 turn-outcome queue
  ...
  concrete scheduler lifecycle、scheduler delivery、event delivery 和 `Tool` adapter。
