...
Implementation plans and closeout records for BitFun (how & when).

This directory must contain only independently executable implementation plans
and `-completed.md` closeout records. Stable architecture moves to
...
| [`sdlc-governance-implementation-plan.md`](sdlc-governance-implementation-plan.md) | in-progress |
| [`sdlc-governance-agent-workflow-staged-plan.md`](sdlc-governance-agent-workflow-staged-plan.md) | in-progress |
