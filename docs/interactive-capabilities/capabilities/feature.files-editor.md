...
- **Agent 可定位入口，需交互完成 / Agent opens; interaction required** · 在 Desktop 本地会话中粘贴或拖放本机文件、文件夹与图片作为上下文
  - Paste or drop local files, folders, and images as context in Desktop local sessions
