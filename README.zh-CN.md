...
[![版本](https://img.shields.io/badge/version-v0.1.0-blue?style=flat-square)](https://github.com/GCWing/BitFun/releases)
...
[![平台支持](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue?style=flat-square)](https://github.com/GCWing/BitFun)
...
<div align="center">
  <img src="./png/live-app-demo.gif" alt="Live App 演示——一句话生成可交互应用" width="800" style="max-width:100%;border-radius:8px;">
  <p><em>一句话 → 一个可用的交互应用。这就是 Live App。</em></p>
</div>
